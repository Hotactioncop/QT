...
void GameZone::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GameZone *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject GameZone::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_GameZone.data,
    qt_meta_data_GameZone,
    qt_static_metacall,
    nullptr,
    nullptr
} };
