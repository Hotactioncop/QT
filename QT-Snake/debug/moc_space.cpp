...
QT_MOC_LITERAL(3, 23, 11), // "changePause"
QT_MOC_LITERAL(4, 35, 8), // "setScore"
QT_MOC_LITERAL(5, 44, 13), // "slotGlassInit"
QT_MOC_LITERAL(6, 58, 9), // "startGame"
QT_MOC_LITERAL(7, 68, 9), // "pauseGame"
QT_MOC_LITERAL(8, 78, 8) // "stopGame"

    },
    "Space\0signalGlassInit\0\0changePause\0"
    "setScore\0slotGlassInit\0startGame\0"
    "pauseGame\0stopGame"
};
...
void Space::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Space::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Space::signalGlassInit)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Space::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Space::changePause)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Space::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Space::setScore)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Space::signalGlassInit()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Space::changePause()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void Space::setScore(int _t1)
{
